...
EVAL_DIR = '/media/cvpr/CM_1/ECCV_2022/robin_new/test'
EVAL_MODEL = '/media/cvpr/CM_1/pytorch-image-classification/ood/imagenet-r/DeepAugment/deepAugment.pth'
#EVAL_MODEL = 'ood/imagenet-r/DeepAugment/model_best.pth.tar'

#EVAL_MODEL = '/home/cvpr/Downloads/efficientformer_l7_300d.pth'

#EVAL_MODEL = 'Semi_Supervised.pth'
...
# please check classes index then arrange the class names accordingly
